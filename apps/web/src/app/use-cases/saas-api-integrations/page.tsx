    ...
    <div className="min-h-screen bg-gray-950 text-white">
      ...
      <main id="main-content">
        <SeoHero
          ...
          description="Your SaaS product depends on Stripe for payments, Twilio for messaging, OpenAI for intelligence, and a dozen more APIs. Each one evolves independently. DriftWatch monitors all of them so a breaking change never catches your team off guard."
